          ...
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product7.jpg" />
              </div>
            </div>
              ...
              <div className="about-full-box-page-left">
                <div className="about-content">
                  ...
                  <p>
                    ...
                    Long Tube Double Tube Rapid Jet Dyeing Machine is designed for high-speed processing of light to heavy-weight woven and knitted fabrics. Its double-tube configuration provides smooth fabric transport at high machine loadings, while the flooded fabric transport system and high-flow dye-liquor circulation support efficient and uniform dyeing.
                  </p>
                  <p>
                    The machine is particularly suitable for crease-sensitive fabrics including polyester, polyester blends, polyamide, microfibers and Lycra blends, as well as pile and wool fabrics.
                  </p>
                  <h5>
                    CAPACITY: From 250 Kg to 500 Kg
                  </h5>
                </div>
                <div className="btb-pd-details">
                  ...
                  <div className="btb-pd-btn">
                    ...
                    <a className="primary-btn1 download-brochure-btn" href="/assets/pdf/LONG-TUBE-CATALOGUE-ANJANI.pdf" target="_blank">
                      <span>
                        DOWNLOAD BROCHURE
                      </span>
                      <span>
      ...
      <div className="key-advantages mb-80">
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="about-pro-lit">
                High-Flow Dye-Liquor Circulation
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Smooth Fabric Transport at High Loading
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
            ...
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Suitable for Crease-Sensitive Fabrics
              </div>
            </div>
          </div>
        </div>
...
export default function PlcBasedLongTubeDoubleTubeRapidJetDyeingMachineSections() {
  return (
    <>
      <Section1 />
      <Section2 />
