            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12">
                <div className="breadcrumb-content">
                  <h1>
                    PLC Based Long Tube Rapid Jet Dyeing Machine
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product6.jpg" />
              </div>
            </div>
            <div className="col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-full-box-page-left">
                <div className="about-content">
                  ...
                  <p>
                    The machine is particularly suitable for crease-sensitive fabrics such as polyester and microfibers, while its large kier and controlled fabric transport help minimize fabric stacking and reduce the possibility of crease formation.
                  </p>
                  <h5>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Fabric Speed up to 500 m/min
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Flooded Fabric Transport System
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Adjustable Nozzle for Controlled Fabric Movement
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
...
export default function PlcBasedLongTubeRapidJetDyeingMachineSections() {
  return (
    <>
      <Section1 />
      <Section2 />
