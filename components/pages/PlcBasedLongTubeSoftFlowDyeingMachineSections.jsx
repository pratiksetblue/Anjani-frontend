            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12">
                <div className="breadcrumb-content">
                  <h1>
                    PLC Based Long Tube Soft Flow Dyeing Machine
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product8.jpg" />
              </div>
            </div>
            <div className="col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-full-box-page-left">
                <div className="about-content">
                  ...
                  <p>
                    The machine is designed with a short chamber, short fabric length and low liquor ratio, while its low nozzle-pressure operation makes it suitable for fabrics requiring gentle and controlled fabric movement.
                  </p>
                  <h5>
                    CAPACITY: From 200 Kg to 500 Kg
                  </h5>
                </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Very Gentle Fabric Handling
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Low-Tension Fabric Processing
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Suitable for Spandex & Stretch Fabrics
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Smooth Operation at Low Nozzle Pressure
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Suitable for Light to Heavy Fabrics
              </div>
            </div>
          </div>
        </div>
...
export default function PlcBasedLongTubeSoftFlowDyeingMachineSections() {
  return (
    <>
      <Section1 />
      <Section2 />
