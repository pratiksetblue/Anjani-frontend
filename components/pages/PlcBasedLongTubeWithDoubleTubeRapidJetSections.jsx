          ...
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product9.jpg" />
              </div>
            </div>
                ...
                <div className="about-content">
                  ...
                  <p>
                    ...
                    <span className="fw-semibold">
                      Autoclaves and Two Nozzles
                    </span>
                    is designed for efficient processing of light to heavy-weight woven and knitted fabrics.
                  </p>
                  <p>
                    The double-rope design provides smooth fabric transport even at high machine loadings. Combined with high-flow dye-liquor circulation and flooded fabric transport, the machine is designed for efficient fabric movement and consistent dye-liquor exchange.
                  </p>
                  <h5>
                    CAPACITY: From 300 Kg to 1000 Kg
                  </h5>
                </div>
...
export function Section3() {
  return (
    <>
      <div className="key-advantages mb-0">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Two Autoclave / Two Nozzle Configuration
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Double-Rope Fabric Processing
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
...
export default function PlcBasedLongTubeWithDoubleTubeRapidJetSections() {
  return (
    <>
      <Section1 />
      <Section2 />
