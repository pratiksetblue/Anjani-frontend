            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12">
                <div className="breadcrumb-content">
                  <h1>
                    PLC Based Low Liquor Ratio ECO+ Soft Flow Dyeing Machine
                  </h1>
                </div>
              </div>
            </div>
...
export function Section2() {
  return (
    <>
      <div className="home1-about-section mt-40 mb-50">
        <div className="container-fluid">
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product1.jpg" />
              </div>
            </div>
              ...
              <div className="about-full-box-page-left">
                <div className="about-content">
                  <p>
                    ...
                    is designed to deliver efficient fabric dyeing with a
                    <span className="fw-semibold">
                      low liquor ratio, reduced process time and optimized energy consumption.
                    </span>
                    Developed with modern soft-flow technology, ECO+ combines controlled fabric movement, automatic nozzle adjustment
    and efficient dye-liquor circulation for consistent processing across a wide range of fabric types.
                  </p>
                  <p>
                    The machine is designed to process fabrics from
                    <span className="fw-semibold">
                      low GSM to high GSM
                    </span>
                    and incorporates
                    <span className="fw-semibold">
                      Double Rope Dyeing Technology,
                    </span>
                    providing flexibility for different fabric constructions and production requirements.
                  </p>
                  <h5>
                    CAPACITY: From 100 Kg to 2000 Kg.
                  </h5>
                </div>
                <div className="btb-pd-details">
                  <h5>
                    Request Technical Offer
                  </h5>
                  <div className="btb-pd-btn">
                    <a className="primary-btn1 whatsapp-btn" href="https://wa.me/917096007670" target="_blank">
                      <span>
...
export function Section3() {
  return (
    <>
      <div className="key-advantages mb-80">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Liquor Ratio Starting from 1:3 to 4
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Reduced Process Time & Energy Consumption
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
            ...
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Teflon Fabric Contact
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Smooth Plaiter Motion
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
      ...
      <div className="pd-table mb-80">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-12">
              <div className="space-model__table-wrap">
                <table className="space-model__table">
                  <thead>
                    <tr>
                      <th>
                        MODEL
...
export default function PlcBasedLowLiquorRatioEcoSoftFlowDyeingMachineSections() {
  return (
    <>
      <Section1 />
      <Section2 />
