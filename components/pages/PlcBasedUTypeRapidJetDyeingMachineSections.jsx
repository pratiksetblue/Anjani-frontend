            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12">
                <div className="breadcrumb-content">
                  <h1>
                    PLC Based U Type Rapid Jet Dyeing Machine
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product3.jpg" />
              </div>
            </div>
            <div className="col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-full-box-page-left">
                <div className="about-content">
                  ...
                  <p>
                    The machine combines a heavy-duty stainless-steel centrifugal pump, inverter-controlled lifter reel, efficient heat exchanger and PLC-based control system to provide controlled and repeatable dyeing operations.
                  </p>
                  <h5>
                    CAPACITY: From 150 Kg to 500 Kg
                  </h5>
                </div>
                <div className="btb-pd-details">
                  ...
                  <div className="btb-pd-btn">
                    ...
                    <a className="primary-btn1 download-brochure-btn" href="/assets/pdf/U-TYPE-CATALOGUE.pdf" target="_blank">
                      <span>
                        DOWNLOAD BROCHURE
                      </span>
                      <span>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-pro-lit">
                9 Segment U Type for smooth Fabric Movement
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
            ...
            <div className="col-lg-6">
              <div className="about-pro-lit">
                High-Speed Fabric Movement up to 350–450 m/min
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Fast Dye-Liquor Circulation
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
            ...
            <div className="col-lg-6">
              <div className="about-pro-lit">
                Automatic Fabric Seam Detection & Cycle Control
              </div>
            </div>
          </div>
        </div>
...
export default function PlcBasedUTypeRapidJetDyeingMachineSections() {
  return (
    <>
      <Section1 />
      <Section2 />
