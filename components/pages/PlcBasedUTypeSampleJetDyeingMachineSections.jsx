            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12">
                <div className="breadcrumb-content">
                  <h1>
                    PLC Based U Type Sample Jet Dyeing Machine
                  </h1>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center g-0">
            <div className="col-lg-5 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-img">
                <img alt="" className="w-100" src="/assets/img/product/product5.jpg" />
              </div>
            </div>
            <div className="col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="about-full-box-page-left">
                <div className="about-content">
                  ...
                  <p>
                    The machine incorporates SS 316L corrosion-resistant construction, high-efficiency dye-liquor circulation and industrial PLC-based process control to provide controlled and repeatable sample dyeing operations.
                  </p>
                  <h5>
                    CAPACITY: From 5 Kg to 100 Kg
                  </h5>
                </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="about-pro-lit">
                5–100 kg Sample Dyeing Capacity
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-pro-lit">
...
export default function PlcBasedUTypeSampleJetDyeingMachineSections() {
  return (
    <>
      <Section1 />
      <Section2 />
